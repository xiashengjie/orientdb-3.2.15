...
public class Arango extends MMDB {
    ...
    @Override
    Object Connection(OrientdbEnum orientdbEnum, String dbUrl) {
        return null;
    }
    ...
    Object Connection(String database){
        ...
        ArangoDB arangoDB = new ArangoDB.Builder()
                .host(split[0], Integer.parseInt(split[1])).user("root").password("root")
                .build();
        return (Object)arangoDB;
    }

    @Override
    long Q1(String PersonId,OrientdbEnum orientdbEnum,String dbUrl) {
        String AQ1 = "WITH Product Post LET customer=(FOR doc IN Customer FILTER doc._key==@key RETURN doc ) "
        ...
        ArangoDB Conn=(ArangoDB)this.Connection(dbUrl);
        ...
        Map<String, Object> bindVars1 = new MapBuilder()
                ...
                .get();
        ArangoCursor<String> cursor1 = Conn.db(orientdbEnum.getName()).query(AQ1,bindVars1,String.class);
    ...
    @Override
    long Q2(String ProductId,OrientdbEnum orientdbEnum,String dbUrl) {

        String AQ2 = "WITH Customer Post Let personlist =(For post in Inbound @id PostHasTag For person in Inbound post._id PersonHasPost limit 100 return person._key) "
        ...
        Map<String, Object> bindVars2 = new MapBuilder()
                ...
                .get();
        ArangoCursor<String> cursor2 = Conn.db(orientdbEnum.getName()).query(AQ2,bindVars2,String.class);
        long millisEnd2 = System.currentTimeMillis();
        System.out.println("Query 2 took "+(millisEnd2 - millisStart2) + " ms");
        return millisEnd2 - millisStart2;
    }

    @Override
    long Q3(String ProductId,OrientdbEnum orientdbEnum,String dbUrl) {
        String AQ3="WITH Post Customer Let posts=(For post in Inbound @id PostHasTag  return post) "
        ...
        Map<String, Object> bindVars3 = new MapBuilder()
                .put("id", "Product/"+ProductId)
                .get();
        ArangoCursor<String> cursor3 = Conn.db(orientdbEnum.getName()).query(AQ3,bindVars3,String.class);
        long millisEnd3 = System.currentTimeMillis();
        System.out.println("Query 3 took "+(millisEnd3 - millisStart3) + " ms");
        return millisEnd3 - millisStart3;
    }

    @Override
    public long Q4(OrientdbEnum orientdbEnum,String dbUrl) {
        String AQ4="WITH Customer let plist=(For order in Order collect PersonId=order.PersonId into group sort SUM(group[*].order.TotalPrice) DESC LIMIT 2 return {PersonId,Monetary:SUM(group[*].order.TotalPrice)}) "
        ...
        ArangoCursor<String> cursor4 = Conn.db(orientdbEnum.getName()).query(AQ4,String.class);
        long millisEnd4 = System.currentTimeMillis();
        System.out.println("Query 4 took "+(millisEnd4 - millisStart4) + " ms");
        return millisEnd4 - millisStart4;
    }

    @Override
    long Q5(String PersonId, String brand,OrientdbEnum orientdbEnum,String dbUrl) {
        String AQ5="WITH Product Post Customer Let Plist=(For friend in 1..1 Outbound @id KnowsGraph "
        ...
        Map<String, Object> bindVars5 = new MapBuilder()
                ...
                .put("brand", brand)
                .get();
        ArangoCursor<String> cursor5 = Conn.db(orientdbEnum.getName()).query(AQ5,bindVars5,String.class);
        long millisEnd5 = System.currentTimeMillis();
        System.out.println("Query 5 took "+(millisEnd5 - millisStart5) + " ms");
        return millisEnd5 - millisStart5;
    }

    @Override
    long Q6(String src, String dst,OrientdbEnum orientdbEnum,String dbUrl) {
        String AQ6="WITH Customer LET shortestPath= (FOR vertex, edge IN OUTBOUND SHORTEST_PATH @customerOne TO @customerTwo KnowsGraph  Return vertex) "
        ...
        Map<String, Object> bindVars6 = new MapBuilder()
                ...
                .get();
        ArangoCursor<String> cursor6 = Conn.db(orientdbEnum.getName()).query(AQ6,bindVars6,String.class);
        long millisEnd6 = System.currentTimeMillis();
        System.out.println("Query 6 took "+(millisEnd6 - millisStart6) + " ms");
        return millisEnd6 - millisStart6;
    }

    @Override
    long Q7(String brand,OrientdbEnum orientdbEnum,String dbUrl) {
        ...
        Map<String, Object> bindVars7 = new MapBuilder()
                .put("brand", brand)
                .get();
        ArangoCursor<String> cursor7 = Conn.db(orientdbEnum.getName()).query(AQ7,bindVars7,String.class);
        long millisEnd7 = System.currentTimeMillis();
        System.out.println("Query 7 took "+(millisEnd7 - millisStart7) + " ms");
        return millisEnd7 - millisStart7;
    }

    @Override
    long Q8(OrientdbEnum orientdbEnum,String dbUrl) {
        ...
        ArangoCursor<String> cursor8 = Conn.db(orientdbEnum.getName()).query(AQ8,String.class);
        long millisEnd8 = System.currentTimeMillis();
        System.out.println("Query 8 took "+(millisEnd8 - millisStart8) + " ms");
        return millisEnd8 - millisStart8;
    }

    @Override
    long Q9(OrientdbEnum orientdbEnum,String dbUrl) {
        String AQ9="WITH Post LET vendors=(For brand in Vendor filter brand.country==\"China\" return brand.name) "
