...
public class Arango extends MMDB {
    ...
    void Q1(String PersonId) {
        ...
        Map<String, Object> bindVars1 = new MapBuilder()
                ...
                .get();
        ArangoCursor<String> cursor1 = Conn.db("testSF10").query(AQ1,bindVars1,String.class);
    ...
    void Q2(String ProductId) {
        ...
        Map<String, Object> bindVars2 = new MapBuilder()
                ...
                .get();
        ArangoCursor<String> cursor2 = Conn.db("testSF10").query(AQ2,bindVars2,String.class);
    ...
    void Q3(String ProductId) {
        ...
        Map<String, Object> bindVars3 = new MapBuilder()
                .put("id", "Product/"+ProductId)
                .get();
        ArangoCursor<String> cursor3 = Conn.db("testSF10").query(AQ3,bindVars3,String.class);
    ...
    void Q5(String PersonId, String brand) {
        ...
        Map<String, Object> bindVars5 = new MapBuilder()
                ...
                .put("brand", brand)
                .get();
        ArangoCursor<String> cursor5 = Conn.db("testSF10").query(AQ5,bindVars5,String.class);
    ...
    void Q6(String src,String dst) {
        ...
        Map<String, Object> bindVars6 = new MapBuilder()
                ...
                .get();
        ArangoCursor<String> cursor6 = Conn.db("testSF10").query(AQ6,bindVars6,String.class);
    ...
    void Q7(String brand) {
        ...
        Map<String, Object> bindVars7 = new MapBuilder()
                .put("brand", brand)
                .get();
        ArangoCursor<String> cursor7 = Conn.db("testSF10").query(AQ7,bindVars7,String.class);
